...
SEIFA <- read_xls("data/SEIFA/raw/2033055001 - ssc indexes.xls", 
  ...
  dplyr::rename(SSC_CODE16 = x1,
                ...
                caution = x12) %>% 
  mutate(SSC_CODE16 = as.integer(SSC_CODE16),
         IRSD_d = as.integer(IRSD),
         IRSAD_d = as.integer(IRSAD),
         IER_d = as.integer(IER),
         IEO_d = as.integer(IEO),
         URP = as.integer(URP)
  ) %>% 
...
saveRDS(dog_expensive_1, "data/costs/clean/dog_expensive_1.Rds")
```

```{r}
dog_expensive_1 <- readRDS("data/costs/clean/dog_expensive_1.Rds")

glimpse(dog_expensive_1)
```
...
saveRDS(dog_expensive_2, "data/costs/clean/dog_expensive_2.Rds")
```

```{r}
dog_expensive_2 <- readRDS("data/costs/clean/dog_expensive_2.Rds")

glimpse(dog_expensive_2)
```
