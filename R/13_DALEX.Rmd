...
# auto ml
m_h2o_aml <- h2o.loadModel("results/m_h2o_aml")
# m_h2o_aml <- h2o.loadModel("results/m_h2o_aml_weight")
```
...
```{r echo=FALSE}
plot(# pdp_cubist, 
     pdp_rf1, pdp_rf2, pdp_xgb, pdp_h2o)
```
...
ale_h2o <- model_profile(explainer_h2o, variable = "poodle", type = "accumulated")
```

```{r echo=FALSE}
plot(# ale_cubist, 
     ale_rf1, ale_rf2, ale_xgb, ale_h2o)
```
...
ale_h2o <- model_profile(explainer_h2o, variable = "staffordshire_bull_terrier", type = "accumulated")
```
