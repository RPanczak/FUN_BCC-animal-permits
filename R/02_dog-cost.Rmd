...
SSC %>% 
  st_drop_geometry() %>% 
  select(IRSD_d_orig, dogs_exp_prop) %>% 
  correlation(method = "kendall")
...
SSC %>% 
  st_drop_geometry() %>% 
  select(IRSAD_d_orig, dogs_exp_prop) %>% 
  correlation(method = "kendall")
...
SSC %>% 
  st_drop_geometry() %>% 
  select(IER_d_orig, dogs_exp_prop) %>% 
  correlation(method = "kendall")
...
SSC %>% 
  st_drop_geometry() %>% 
  select(IEO_d_orig, dogs_exp_prop) %>% 
  correlation(method = "kendall")
